describe('tddd app', function() {
  ...
  describe('editor page', function() {
    beforeEach(function() {
      browser.get('/#/gitlab/x3CWFcfYtxQLmTrg3kQ7/repos/241/blobs/668a1ad79ff/fnc_get_factor.fnc/ut_get_factor.pck');
    });
    ...
    it('should set next and prev style and url correctly', function() {
      ...
      expect(element(by.css('.next')).getAttribute('href')).toContain('/gitlab/x3CWFcfYtxQLmTrg3kQ7/repos/241/blobs/8d125892f02/fnc_get_factor.fnc/ut_get_factor.pck');
    });

    it('should go to next commit after clicking next link', function() {
      element(by.css('.next')).click();
      expect(browser.getCurrentUrl()).toContain('/gitlab/x3CWFcfYtxQLmTrg3kQ7/repos/241/blobs/8d125892f02/fnc_get_factor.fnc/ut_get_factor.pck');
    });
  });
});
